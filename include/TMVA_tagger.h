...
class TMVA_tagger{
 ...
 Float_t m_pf_pt[100];
 Float_t m_pf_phi[100];
 Float_t m_pf_eta[100];
 Float_t m_pf_energy[100];
 Float_t m_pf_charge[100];
 ...
 Float_t  qjet_mmin;
 Float_t qjet_mass;
 Float_t qjet_nsubjets;
 Float_t  qjet_nsubjettiness1;
 Float_t qjet_nsubjettiness2;
 Float_t qjet_nsubjettiness3;
 Float_t jwj01;
 Float_t jwj02;
 Float_t jwj03;
 Float_t jwj04;
...
static TMVA_tagger* Instance();
 ...
 Double_t GetMVA_value(bool BDT);
};
