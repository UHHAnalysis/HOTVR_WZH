...
void SubstructureHists::Init()
{
  ...
  Book( TH1D( "pT"," p_{T}",100,0,2000));
  Book( TH1D( "pT_ly"," p_{T}",100,0,2000));
  Book( TH1D( "eta"," #eta",100,-3,3));
  Book( TH1F( "phi"," #phi",100,-M_PI,M_PI));
  Book(TH1D("nsubjets","number subjets",11,0,10));
  Book(TH1D("subjet1pt","p_{T} leading subjet [GeV]",70,0,1000));
  Book(TH1D("subjet1pt_ly","p_{T} leading subjet [GeV]",70,0,1000));
  Book(TH1D("subjet2pt","p_{T} 2nd subjet [GeV]",70,0,500));
  Book(TH1D("subjet2pt_ly","p_{T} 2nd subjet [GeV]",70,0,500));
  Book(TH1D("subjet3pt","p_{T} 3rd subjet [GeV]",70,0,500));
  Book(TH1D("subjet3pt_ly","p_{T} 3rd subjet [GeV]",70,0,500));
  Book(TH1D("Jetmass","jet mass [GeV]",50,0,500));
  Book(TH1D("Subjetmass12","subjet mass_{12} [GeV]",100,0,300));
  Book(TH1D("Subjetmass13","subjet mass_{13} [GeV]",100,0,300));
  Book(TH1D("Subjetmass23","subjet mass_{23} [GeV]",100,0,300));
  Book(TH1D("subjet_mmin","m_{min} [GeV]",100,0,160));
  ...
  Book(TH1D("Jetmasspruned","pruned jet mass [GeV]",50,0,500));
  Book(TH1D("Subjetmass12pruned","pruned subjet mass_{12p} [GeV]",100,0,150));
  Book(TH1D("Subjetmass13pruned","pruned subjet mass_{13p} [GeV]",100,0,150));
  Book(TH1D("Subjetmass23pruned","pruned subjet mass_{23p} [GeV]",100,0,150));
  Book(TH1D("tau1pruned","pruned N-subjettiness #tau_{1p}",50,0,1));
  Book(TH1D("tau2pruned","pruned N-subjettiness #tau_{2p}",50,0,1));  
  Book(TH1D("tau3pruned","pruned N-subjettiness #tau_{3p}",50,0,1));
  Book(TH1D("tau3tau2pruned","pruned N-subjettiness #tau_{3p}/#tau_{2p}",50,0,1));
  Book(TH1D("tau2tau1pruned","pruned N-subjettiness #tau_{2p}/#tau_{1p}",50,0,1));
  Book(TH1D("Qvolatility","Q-jets volatilty",30,0,0.6));
  Book(TH1D("HelAng12","Helicity angle subjet_{1,2}",35,0,3.5));
  Book(TH1D("HelAng13","Helicity angle subjet_{1,3}",35,0,3.5));
  Book(TH1D("HelAng23","Helicity angle subjet_{2,3}",35,0,3.5));
  Book( TH1F( "psi02_ly","Jetshapes #Psi (0.2)",35,0,1.4));
  Book( TH1F( "psi04_ly","Jetshapes #Psi (0.4)",35,0,1.4));
  Book( TH1F( "psi06_ly","Jetshapes #Psi (0.6)",35,0,1.4));
  Book( TH1F( "psi08_ly","Jetshapes #Psi (0.8)",35,0,1.4));
  Book( TH1F( "psi10_ly","Jetshapes #Psi (1.0)",35,0,1.4));
  ...
  Book( TH1F( "jet_charge","jet charge",100,-50,50));
  Book( TH1F( "weighted_jet_charge","weighted jet charge",55,-1,1));
  Book( TH1F( "weighted_jet_charge_02","weighted jet charge k=0.2",100,-10,10));
  Book( TH1F( "weighted_jet_charge_04","weighted jet charge k=0.4",105,-5,5));
  Book( TH1F( "weighted_jet_charge_06","weighted jet charge k=0.6",105,-2,2));
  Book( TH1F( "weighted_jet_charge_08","weighted jet charge k=0.8",105,-2,2));
  Book( TH1F( "first_jet_moment", "first moment",100,0,1));
  Book( TH1F( "second_jet_moment", "second moment",100,0,1));
  ...
  Book( TH1F( "NMicrojets", "number of microjets", 11,-0.5,10.5) );
   Book(TH1D("MMicrojet","leading m_{microjets}",100,0,400));
...
void SubstructureHists::Fill2(TopJet topjet, double mva_value)
{
 ...
 if(HelAng23!=0) Hist("HelAng23")->Fill(HelAng23,weight);
  ...
  /* Hist("psi02")->Fill(m_psi_02,weight);
  Hist("psi04")->Fill(m_psi_04,weight);
  Hist("psi06")->Fill(m_psi_06,weight);
  Hist("psi08")->Fill(m_psi_08,weight);
  Hist("psi10")->Fill(m_psi_10,weight);*/
