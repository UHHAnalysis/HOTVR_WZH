...
//antitag=true;
  ...
  double m_second_jet_moment = calc->JetMoment(&topjet,2);
   ...
   Hist("second_jet_moment")->Fill(m_second_jet_moment,weight);*/
	...
	if(topjet.pt()>350) Hist("eta_s1_cms_tagged")->Fill(topjet.eta(),weight);
      }
	...
	Hist("pT_s1_hep_tagged_ly")->Fill(topjet.pt(),weight);
	 ...
	 Hist("pT_s1_hep_tagged_ly")->Fill(topjet.pt(),weight);
	    ...
	    if(topjet.pt()>350) Hist("eta_s1_hep3_tagged")->Fill(topjet.eta(),weight);
	   ...
	   if(topjet.pt()>350) if(Rmin-Rmin_exp<1.0 && mass_Rmin>140 && mass_Rmin<250 )  Hist("eta_s1_multiWP1_tagged")->Fill(topjet.eta(),weight);
	   ...
	   if(topjet.pt()>350) if(Rmin-Rmin_exp<0.07 && mass_Rmin>140 && mass_Rmin<250 )  Hist("eta_s1_multiWP0_tagged")->Fill(topjet.eta(),weight);
			  if(Rmin-Rmin_exp<0.5 /*&& mass_Rmin>140 && mass_Rmin<500*/ )  Hist("pT_s1_multiWP2_tagged")->Fill(topjet.pt(),weight);
			    ...
			    if(topjet.pt()>350) if(Rmin-Rmin_exp<0.5 /*&& mass_Rmin>100 && mass_Rmin<250*/ )  Hist("eta_s1_multiWP2_tagged")->Fill(topjet.eta(),weight);
			 }
 ...
 //softdrop
	    ...
	    if(topjet.v4().M()>110 && topjet.v4().M()<210) Hist("pT_s1_mass_tagged")->Fill(topjet.pt(),weight);
	     if(topjet.pt()>350) if(groomed_jet.m()>110 && groomed_jet.m()<210) Hist("npv_s1_softdrop_tagged")->Fill(Npvs,weight);
	     if(topjet.pt()>350) if(groomed_jet.m()>110 && groomed_jet.m()<210) Hist("eta_s1_softdrop_tagged")->Fill(topjet.eta(),weight);
	    if(topjet.pt()>350) if(topjet.v4().M()>110 && topjet.v4().M()<210) Hist("npv_s1_mass_tagged")->Fill(Npvs,weight);
 ...
 if(topjet.tau3()/topjet.tau2()<0.6){
	    ...
	    if(groomed_jet.m()>110 && groomed_jet.m()<210 && topjet.pt()>350) Hist("eta_s1_softdrop_tau_tagged")->Fill(topjet.eta(),weight);
	 ...
	 fastjet::PseudoJet groomed_jet2;
	    ...
	    Hist("softdrop2_pT_softdrop")->Fill(groomed_jet.perp(),weight);
	    Hist("softdrop2_mass_softdrop")->Fill(groomed_jet.m(),weight);
	    if(topjet.pt()>200){
	     Hist("softdrop2_mass_jet200")->Fill(topjet.v4().M(),weight);
	     Hist("softdrop2_mass_softdrop200")->Fill(groomed_jet.m(),weight);
	    }
	    if(topjet.pt()>400){
	     Hist("softdrop2_mass_jet400")->Fill(topjet.v4().M(),weight);
	     Hist("softdrop2_mass_softdrop400")->Fill(groomed_jet.m(),weight);
	    }
	    if(topjet.pt()>600){
	     Hist("softdrop2_mass_jet600")->Fill(topjet.v4().M(),weight);
	     Hist("softdrop2_mass_softdrop600")->Fill(groomed_jet.m(),weight);
	    }
	     if(groomed_jet2.m()>110 && groomed_jet2.m()<210) Hist("pT_s1_softdrop2_tagged")->Fill(topjet.pt(),weight);
	   
	     if(topjet.pt()>350) if(groomed_jet2.m()>110 && groomed_jet2.m()<210) Hist("npv_s1_softdrop2_tagged")->Fill(Npvs,weight);
	     if(topjet.pt()>350) if(groomed_jet2.m()>110 && groomed_jet2.m()<210) Hist("eta_s1_softdrop2_tagged")->Fill(topjet.eta(),weight);
	   

 if(topjet.tau3()/topjet.tau2()<0.6){
	    Hist("softdrop2_pT_jet_tau")->Fill(topjet.pt(),weight);
	    Hist("softdrop2_mass_jet_tau")->Fill(topjet.v4().M(),weight);
	    Hist("softdrop2_pT_softdrop_tau")->Fill(groomed_jet.perp(),weight);
	    Hist("softdrop2_mass_softdrop_tau")->Fill(groomed_jet.m(),weight);
	    if(topjet.pt()>200){
	     Hist("softdrop2_mass_jet200_tau")->Fill(topjet.v4().M(),weight);
	     Hist("softdrop2_mass_softdrop200_tau")->Fill(groomed_jet.m(),weight);
	    }
	    if(topjet.pt()>400){
	     Hist("softdrop2_mass_jet400_tau")->Fill(topjet.v4().M(),weight);
	     Hist("softdrop2_mass_softdrop400_tau")->Fill(groomed_jet.m(),weight);
	    }
	    if(topjet.pt()>600){
	     Hist("softdrop2_mass_jet600_tau")->Fill(topjet.v4().M(),weight);
	     Hist("softdrop2_mass_softdrop600_tau")->Fill(groomed_jet.m(),weight);
	    }
	    if(groomed_jet2.m()>110 && groomed_jet2.m()<210) Hist("pT_s1_softdrop2_tau_tagged")->Fill(topjet.pt(),weight);
	    if(groomed_jet2.m()>110 && groomed_jet2.m()<210 && topjet.pt()>350) Hist("eta_s1_softdrop2_tau_tagged")->Fill(topjet.eta(),weight);
	 ...
	 if(log(chi)>2)  Hist("eta_s1_sdWP0_tagged")->Fill(topjet.eta(),weight);
	 if(log(chi)>3.5)  Hist("eta_s1_sdWP1_tagged")->Fill(topjet.eta(),weight);
	 if(log(chi)>5)  Hist("eta_s1_sdWP2_tagged")->Fill(topjet.eta(),weight);}
	 CA15matched=true;
	 //}
	 //}
