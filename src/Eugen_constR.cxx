...
// //Eugen::Eugen(const char* name, int _rho, double _theta, int _mu) : BaseHists(name), rho(_rho), theta(_theta), mu(_mu)
// Eugen::Eugen(const char* name) : BaseHists(name)
// {}
...
//   // ZPrimeMasse
//   Book( TH1F( "ZPrimeMasse",                "Masse des ZPrime", 75, 0, 2500));       
//   Book( TH1F( "ZPrimeMasse pT < 200",       "Masse des ZPrime", 75,0, 2500));       
//   Book( TH1F( "ZPrimeMasse 200 < pT < 400", "Masse des ZPrime", 75, 0, 2500));       
//   Book( TH1F( "ZPrimeMasse 400 < pT < 600", "Masse des ZPrime", 75, 0, 2500));       
//   Book( TH1F( "ZPrimeMasse 600 < pT < 800", "Masse des ZPrime", 75, 0, 2500));       
//   Book( TH1F( "ZPrimeMasse pT > 800",       "Masse des ZPrime", 75, 0, 2500));
...
//   // MMin
//   Book( TH1F( "MMin" ,"", 75, 0, 300));
//   Book( TH1F( "MMin pT < 200" ,"", 75, 0, 300));
//   Book( TH1F( "MMin 200 < pT < 400" ,"", 75, 0, 300));
//   Book( TH1F( "MMin 400 < pT < 600" ,"", 75, 0, 300));
//   Book( TH1F( "MMin 600 < pT < 800" ,"", 75, 0, 300));
//   Book( TH1F( "MMin pT > 800" ,"", 75, 0, 300));
...
//   double mw(0.), mWlow(50.), mWhigh(140.); // Alte Originalwerte
//  // double mu(20.), theta(0.6),
//  //mw(0.), mWlow(50.), mWhigh(140.);
...
//   // EFFICIENCY
//   if(!IsRealData && (idVersion=="WW_500_Gen" || idVersion=="WW_1000_Gen" || idVersion=="WW_1500_Gen" || idVersion=="WW_2000_Gen" || idVersion.Contains("Zprime")))
//     {
...
// 	  for(int o = 0; o < fatjets.size(); o++)                                                                     //     Hier werden die Jets gefunden.  perp() == pt() hier!
// 	    {
// 	      //  Hists AllJets
...
// 			  cout<<"fatjets[o].user_index() = "<< fatjets[o].user_index() <<endl;
...
// 		  cout<<" TempJets1.at(0).pt() = " <<   TempJets1.at(0).pt()     <<endl;
...
// 		  cout<<" TempJets1.at(1).pt() = " <<   TempJets1.at(1).pt()     <<endl;
...
// 		  cout<<" TempJets1.at(2).pt() = " <<   TempJets1.at(2).pt()     <<endl;
...
// 		 //   Testhistogramme
// 	      cout<<" subjets[fatjets_comb.size()-1].at(1).pt() = " <<subjets[fatjets_comb.size()-1].at(1).pt()<<endl;
// 	      cout<<" subjets[fatjets_comb.size()-1].at(2).pt() = " <<subjets[fatjets_comb.size()-1].at(2).pt()<<endl;
// 	      cout<<" subjets[fatjets_comb.size()-1].at(3).pt() = " <<subjets[fatjets_comb.size()-1].at(3).pt()<<endl;
...
// 	      if(SortedSubJets2.size() > 1 && SortedJets[bestjetindex2].m() > mWlow && SortedJets[bestjetindex2].m() < mWhigh && SortedSubJets2.at(0).pt() > 30 && SortedSubJets2.at(1).pt() > 30 &&                                         SortedSubJets2.at(0).pt() / SortedJets[bestjetindex2].pt() < 0.8 && mmin > 50 && abs(minDeltaR2) < 3.5 ) 	         
// 		{    
// 		                                                              Hist("LastTagger")->Fill(Had_Ws[j].pt(), weight); 
// 		      if(Had_Ws[j].pt() < 200)                                Hist("LastTagger pT < 200")->Fill(Had_Ws[j].pt(), weight); 
// 		      if(Had_Ws[j].pt() > 200 && Had_Ws[j].pt() < 400)        Hist("LastTagger 200 < pT < 400")->Fill(Had_Ws[j].pt(), weight); 
...
// 	      if(SortedSubJets.size() > 1 && varjets[i].m() > mWlow && varjets[i].m() < mWhigh  && SortedSubJets.at(0).pt() > 30 && SortedSubJets.at(1).pt() > 30 && SortedSubJets.at(0).pt() / varjets[i].pt() < 0.8 && mmin > 50                   && abs(DeltaRCut) < 3.5)      
// 		{
